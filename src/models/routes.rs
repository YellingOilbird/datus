use crate::models::{AccountsInteracted, DailyTransactions, Transactions, ReportConfig, FungibleTokenDeposits};
...
// Example: get limited receipts by ActionKind
// #[get("/receipts/{params}")]
...
pub fn init_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(get_daily_transactions);
